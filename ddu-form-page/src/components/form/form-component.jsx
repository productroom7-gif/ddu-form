...
const makeValidationSchema = (t) => Yup.object({
  ...
  phone: Yup.string()
    ...
    .test("len", t.errPhoneLen, function(value) {
      ...
      // EU phone numbers vary in length. Validate against the E.164 limit
      // while keeping the selected country restricted to EU member states.
          ...
          <>
            ...
            <SectionContainer marginbottom="48px">
              <CheckboxInput
                title={
                  <>
                    {t.personalBefore}<a href="/documents/processing-of-my-personal-data.pdf" target="_blank" rel="noopener noreferrer">{t.personalLink}</a>{t.personalAfter}
                  </>
                }
                name="personalData"
                form={form}
              ...
              <CheckboxInput
                title={
                  <>
                    {t.authorizeBefore}<a href="/documents/authorization.pdf" target="_blank" rel="noopener noreferrer">{t.authorizeLink}</a>{t.authorizeAfter}
                  </>
                }
                name="authorizeInput"
                form={form}
        ...
        {selectedShipment === "company" && (
          <>
            ...
            <SectionContainer>
              ...
              <InputsRow>
                <ContactCard icon="fa-phone" title={t.phoneSupport} descriptionTitle="+48 34 365-91-15" description={t.phoneHours} />
                <ContactCard icon="fa-envelope" title={t.emailSupport} descriptionTitle="info@karex.info.pl" description={t.response24} />
              </InputsRow>

               <InputsRow>
                <ContactCard icon="fa-map-marker" title={t.officeAddress} descriptionTitle="Karex Paczka sp. Z o.o." description={<>ul. Młodości 67,<br />42-200 Częstochowa<br />{t.poland}</>} />
              </InputsRow>
